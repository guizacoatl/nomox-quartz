...
---
> [!info]+
> 🔗 Retour au [[2016R0957_FR.0|Sommaire]]. 🇬🇧 Version Anglaise: [[2016R0957_EN.6]]. Ouvrir le [[CELEX_32016R0957_FR_TXT.pdf|PDF]]. Direct link to [EUR-LEX](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX%3A32016R0957).
>
...
## 1.
Les personnes qui organisent ou exécutent des transactions à titre professionnel et les opérateurs de marché et entreprises d'investissement qui gèrent une plate-forme de négociation veillent à mettre en place des mesures, systèmes et procédures efficaces permettant de transmettre une STOR sans retard conformément à l'[[2016R0957_FR.16|article 16]], paragraphes 1 et 2, du règlement (EU) no 596/2014 dès lors qu'il existe des soupçons raisonnables d'opération d'initié, de manipulation ou de tentative d'opération d'initié ou de manipulation de marché.
## 2.
