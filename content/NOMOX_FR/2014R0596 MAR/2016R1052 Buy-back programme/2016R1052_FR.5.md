...
---
> [!info]+
> 🔗 Retour au [[2016R1052_FR.0|Sommaire]]. 🇬🇧 Version Anglaise: [[2016R1052_EN.5]]. Ouvrir le [[CELEX_32016R1052_FR_TXT.pdf|PDF]]. Direct link to [EUR-LEX](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX%3A32016R1052).
>
...
> Level 1 reference(s): [[2014R0596_FR.5#4#a]]

# Article 5 - Conditions concernant la période de stabilisation

## 1.
Pour les actions et autres titres équivalant à des actions, la période limitée visée à l'[[2014R0596_FR.5#4#a)|article 5, paragraphe 4, point a) du règlement (UE) no 596/2014]] (ci-après la «période de stabilisation»):
### a)
