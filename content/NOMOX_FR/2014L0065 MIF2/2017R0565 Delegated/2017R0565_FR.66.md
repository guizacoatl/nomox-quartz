...
---
> [!info]+
> 🔗 Retour au [[2017R0565_FR.0|Sommaire]]. 🇬🇧 Version Anglaise: [[2017R0565_EN.66]]. Ouvrir le [[CELEX_02017R0565-20220802_FR_TXT.pdf|PDF]]. Direct link to [EUR-LEX](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX%3A02017R0565-20220802).
>
...
> Level 1 reference(s): [[2014L0065_FR.27#7]], [[2014L0065_FR.27#5]]

# Article 66 - Politique d'exécution

## 1.
Les entreprises d'investissement réexaminent au moins annuellement la politique d'exécution établie conformément à l'[[2014L0065_FR.27#4|article 27, paragraphe 4 de la directive 2014/65/UE]] ainsi que leurs dispositions en matière d'exécution des ordres.
...
### a)
l'importance relative que l'entreprise d'investissement attribue, sur la base des critères définis à l'[[2017R0565_FR.59#1|article 59, paragraphe 1]], aux facteurs mentionnés à l'[[2014L0065_FR.27#1|article 27, paragraphe 1 de la directive 2014/65/UE]], ou le processus par lequel l'entreprise détermine l'importance relative desdits facteurs;
### b)
...
Cette information est fournie sur un support durable, ou sur un site web (qui ne constitue pas un support durable) pour autant que les conditions énoncées à l'[[2017R0565_FR.3#2|article 3, paragraphe 2]], soient remplies.
## 4.
...
## 6.
Les entreprises d'investissement ne reçoivent de paiements de tiers que s'ils sont conformes à l'[[2014L0065_FR.24#9|article 24, paragraphe 9 de la directive 2014/65/UE]] et informent les clients des incitations dont elles bénéficient éventuellement de la part des plates-formes d'exécution. Ces informations précisent les frais facturés par l'entreprise d'investissement à toutes les contreparties impliquées dans la transaction, et lorsque les frais varient en fonction du client, elles indiquent les frais maximum ou l'éventail de frais applicables.
## 7.
Une entreprise d'investissement qui facture une transaction à plusieurs participants, conformément à l'[[2014L0065_FR.24#9|article 24, paragraphe 9 de la directive 2014/65/UE]] et à ses mesures d'exécution, informe ses clients de la valeur de tout avantage monétaire ou non monétaire dont elle bénéficie.
## 8.
...
## 9.
Lorsqu'une entreprise d'investissement exécute des ordres pour des clients de détail, elle fournit à ces clients un résumé de sa politique en la matière, mettant l'accent sur leur coût total. Ce résumé comprend également un lien vers les données les plus récentes sur la qualité d'exécution publiées conformément à l'[[2014L0065_FR.27#3|article 27, paragraphe 3 de la directive 2014/65/UE]], pour chaque plate-forme d'exécution répertoriée par l'entreprise d'investissement dans sa politique d'exécution.
