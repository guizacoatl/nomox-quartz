...
---
> [!info]+
> 🔗 Retour au [[2017R0589_FR.0|Sommaire]]. 🇬🇧 Version Anglaise: [[2017R0589_EN.13]]. Ouvrir le [[CELEX_32017R0589_FR_TXT.pdf|PDF]]. Direct link to [EUR-LEX](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX%3A32017R0589).
>
...
## 1.
Les entreprises d'investissement assurent le suivi de toutes les activités de négociation menées par l'intermédiaire de leurs systèmes de négociation, y compris celles de leurs clients, pour détecter d'éventuels signes de manipulation de marché telle que définie à l'[[2014R0596_FR.12|article 12 du règlement (UE) no 596/2014]].
## 2.
