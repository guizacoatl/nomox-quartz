...
surnom_texte_lvl2: CASP acquisition of qualify holding
texte: 2025R0414
consolidated: False
in_force: true
level: 2
...
## 4.
Lorsque le candidat acquéreur est un fonds d’investissement alternatif (FIA) au sens de l’[[2011L0061_FR.4#1#a|article 4, paragraphe 1, point a), de la directive 2011/61/UE]], ou un organisme de placement collectif en valeurs mobilières (OPCVM) agréé conformément à l’[[2009L0065_FR.5|article 5 de la directive 2009/65/CE]], son gestionnaire de fonds d’investissement alternatif ou le FIA dans le cas d’un FIA géré en interne, ou sa société de gestion d’OPCVM ou la société d’investissement OPCVM dans le cas d’un OPCVM autogéré, fournit à l’autorité compétente de l’entité cible les informations suivantes:
### a)
