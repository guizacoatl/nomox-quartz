...
### (a)
whether the new administrator proposed in the assessment submitted by the current administrator pursuant to [[2021R1349_EN.21#1#b|Article 21(1), point (b)]](i), of Regulation (EU) 2016/1011:
#### (i)
...
#### (iv)
is already authorised as a benchmark administrator under [[2016R1011_EN.34|Article 34 of Regulation (EU) 2016/1011]];
#### (v)
...
### (f)
where the critical benchmark is based on input data contributed by a panel of contributors, how the new administrator intends to fulfil the requirement set out in [[2016R1011_EN.11#1#d|Article 11(1), point (d), of Regulation (EU) 2016/1011]] and whether the current contributors will continue to be part of the panel after the benchmark’s transition to the new administrator;
### (g)
