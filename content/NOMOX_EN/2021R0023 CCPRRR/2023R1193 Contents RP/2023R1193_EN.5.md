...
## 1.
When preparing an estimation of the time frame for implementation of the resolution plan in accordance with [[2021R0023_EN.12#7#d|Article 12(7), point (d), of Regulation (EU) 2021/23]], the resolution authority shall ensure that at least the following elements are included in the resolution plan:
### (a)
