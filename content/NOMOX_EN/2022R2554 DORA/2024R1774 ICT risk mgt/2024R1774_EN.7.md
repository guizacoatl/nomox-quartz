...
---
> [!info]+
> 🔗 Back to [[2024R1774_EN.0|Summary]]. 🇫🇷 French Version: [[2024R1774_FR.7]]. Back to [[2022R2554_EN.0|Summary]] of LVL1. Direct link to [EUR-LEX](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A02024R1774-20240625).
>
...
## 1.
Financial entities shall include in the cryptographic key management policy referred to in [[2024R1774_EN.6#2#d|Article 6(2), point (d)]], requirements for managing cryptographic keys through their whole lifecycle, including generating, renewing, storing, backing up, archiving, retrieving, transmitting, retiring, revoking, and destroying those cryptographic keys.
## 2.
