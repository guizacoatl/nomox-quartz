...
However, competent authorities may require AIFMs to ensure that any or all of those records are retained for a longer period, taking into account the nature of the asset or portfolio transaction, where it is necessary to enable the authority to exercise its supervisory functions under [[2011L0061_EN.0|Directive 2011/61/EU]].
## 2.
