...
[ESMA 70-872942901-38 MiFID II MiFIR market structures Q&A, Q&A 5.22]
...
Accordingly, to be authorised as an OTF, a multilateral trading system must offer trading in the financial instruments listed above, without prejudice to the other requirements to be met for such authorisation.
However, a trading platform that is authorised as an OTF based on trading financial instruments can, in addition, offer trading in wholesale energy contracts that must be physically settled (“REMIT carve-out” contracts).
