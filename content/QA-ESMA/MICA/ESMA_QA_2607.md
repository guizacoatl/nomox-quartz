...
> **Link to ESMA Q&A tool:** https://www.esma.europa.eu/publications-data/questions-answers/2607
...
**Subject Matter:** Staking on own account
...
**Submission Date:** 04 February 2025
...
Article 70(1) of MiCA provides that CASPs that “hold crypto-assets belonging to clients or the means of access to such crypto-assets shall make adequate arrangements to (…) prevent the use of clients’ crypto-assets for their own account”.
CASPs are thus expected to refrain from using clients’ crypto-assets for their own account. Consequently, MiCA does not allow the staking of clients’ crypto-assets by CASPs for their own account, even in cases where the client has explicitly provided consent. In line with the European Commission Q&A 2067 available on ESMA’s website, CASPs and clients may mutually agree on the terms under which staking-as-a-service is provided by the CASP, provided that the profits from staking do not solely benefit the CASP1.
