...
[ESMA 33-128-563 Securitisation Q&A, Q&A 5.1.8.b]
For background, the following restates the “Content To Report” for each field:
...
SEAR42 (Purchased Amount) should contain the amount of underlying exposures purchased from the originator in this transaction between the previous data cut-off date and the data cut-off date of the present data submission. 
IVAL25 (Financed Amount) Should contain the amount of underlying exposures purchased from the originator in this transaction that have been financed by commercial paper, between the previous data cut-off date and the data cut-off date of the present data submission. 
SEAS13 (Total Issuance) Should contain the total programme issuance outstanding, converted into EUR. 
