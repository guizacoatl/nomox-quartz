...
[ESMA 33-128-563 Securitisation Q&A, Q&A 5.14.19]
In this situation, the risk weight approach associated with the highest share of underlying exposures in terms of value should be reported. For example, if EUR 500 million of underlying exposures in the securitisation follow the Foundation Internal Ratings-Based (FIRB) approach and another EUR 700 million of underlying exposures in the securitisation follow the Advanced Internal Ratings-Based (AIRB) approach, then IVSS30 should be completed with ‘AIRB’.
