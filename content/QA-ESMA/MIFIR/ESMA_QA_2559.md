...
> **Link to ESMA Q&A tool:** https://www.esma.europa.eu/publications-data/questions-answers/2559
...
**Linked Articles:** [[2014R0600_EN.39a]]
...
**Subject Matter:** Payment for order flow (PFOF) prohibition and OTC execution of client orders
...
The scope of application of Article 39a of MiFIR should be considered taking into account the core policy objectives of MiFIR, including:(a) investor protection;(b) execution of orders in the best interest of clients.Since those objectives support the broadest possible coverage of execution venues, the prohibition should be understood as applying not only to transactions executed on a trading venue, but also to transactions executed over the counter (OTC).
