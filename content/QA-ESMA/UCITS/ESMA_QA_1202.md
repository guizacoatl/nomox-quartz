...
[ESMA 34-43-392 UCITS Q&A, section 6, Q&A 1]
No. The UCITS framework requires UCITS management companies to have in place a process for accurate and independent verification of the value of the OTC financial derivative transactions, even if they are centrally cleared. The valuation provided by the CCP can only serve as a point of reference for the verification performed by the UCITS management company. Nevertheless, the UCITS management company should be able to justify any deviation from the valuation provided by the CCP.
