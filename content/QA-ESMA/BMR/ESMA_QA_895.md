...
> **Link to ESMA Q&A tool:** https://www.esma.europa.eu/publications-data/questions-answers/895
...
**Subject Matter:** EU Climate Transition Benchmarks and EU Paris-Aligned Benchmarks
...
What are the disclosure requirements that an administrator of an EU Climate Transition Benchmark (EU CTB) or an EU Paris-aligned Benchmark (EU PAB) should comply with?
...
Chapter III of the Delegated Regulation (EU) 2020/1818 on the minimum standards for EU CTB and EU PAB includes transparency requirements for administrators of EU CTB and EU PAB on the methodology used for the estimation, the decarbonisation trajectory and the data sources.
Further, pursuant to Articles 3(1)(23a) and (23b) of the BMR[1], the underlying assets of such benchmarks are selected, weighted or excluded in such a manner that the resulting portfolio of an EU CTB is on a decarbonisation trajectory whereas the resulting portfolio’s carbon emissions of an EU PAB are aligned with the objectives of the Paris Agreement.
