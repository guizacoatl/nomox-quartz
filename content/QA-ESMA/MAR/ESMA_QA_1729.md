...
[ESMA70-145-111 MAR Q&A, Q&A 7.3]
No, the transactions carried out by a PDMR and by closely associated persons to that PDMR should not be aggregated.
This involves that where the overall transactions singularly carried out by either a PDMR or any closely associated person to that PDMR do not reach the threshold, those persons should not notify those transactions even where the threshold is reached aggregating all the transactions carried out by the PDMR and all the closely associated persons to them.
